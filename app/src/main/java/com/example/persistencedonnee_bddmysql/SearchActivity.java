...
public class SearchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editLocalite = (EditText)findViewById(R.id.edit_LocaliteSearch);
        editDdn = (EditText)findViewById(R.id.edit_DdnSearch);
    ...
    private void userRequests() {
        ...
        final String localite = editLocalite.getText().toString().trim();
        final String ddn = editDdn.getText().toString().trim();

        String getUrl = Constante.URL_SEARCH+"?username="+username+"&email="+email+"&localite="+localite+"&ddn="+ddn;
                ...
                try {
                    ...
                    if (!jsonObject.getBoolean("error")) {
                        ...
                        for(int i =0; i < jsonUsers.length();i++) {
                            ...
                            User user = new User(object.getString("username"),object.getString("email"),object.getString("localite"),object.getString("ddn"));
                            userList.add(user);
                        }
                        ...
                        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                User user = new User(userList.get(position).getUsername(),userList.get(position).getEmail(),userList.get(position).getLocalite(),userList.get(position).getDdn());
