...
public class UserDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localiteTxt = (TextView)findViewById(R.id.LocaliteDetail);
        ddnTxt = (TextView)findViewById(R.id.DdnDetail);
        ...
        localiteTxt.setText(user.getLocalite());
        ddnTxt.setText(user.getDdn());
